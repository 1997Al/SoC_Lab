...
HD_PWD='D:/Master/SoC_Lab/Xilinx/SoC_Lab/SoC_Lab.runs/design_1_axi_gpio_A_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_A_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_A_0.tcl
